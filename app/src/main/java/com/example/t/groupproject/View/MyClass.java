...
/**
 * View that user can see their selected courses
 */
public class MyClass extends AppCompatActivity implements ValueEventListener {
    private static final String TAG = "MyClass";

    private String courseName, faculty, userUid;
    private DatabaseReference sectionDataRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sectionDataRef = FirebaseDatabase.getInstance().getReference()
                .child("UserInfo").child(userUid).child("registered_courses");
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot section : dataSnapshot.getChildren()) {
            ...
            sectionId = String.valueOf(section.child("section_id").getValue());
